...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>tabbedPlaylist.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/pluginName.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>tabbedPlaylist.css</strong>.</td>
    </tr>
  </tbody>
</table>
